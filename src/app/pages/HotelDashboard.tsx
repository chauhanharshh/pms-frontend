          ...
          <div className="space-y-2 pt-2">
            {room.status === "vacant" && (
              <button
                ...
                className="w-full py-4 rounded-xl font-bold text-white text-sm transition-all shadow-md" // Removed: active scale animation for instant click response
                style={{
  ...
  return (
    <AppLayout title="Hotel Dashboard" requiredRole="hotel">
      ...
      >
        ...
        {/* Removed: Quick Actions section from dashboard (UI cleanup) */}
        {/* Removed: Active Bookings section from dashboard (UI cleanup) */}
      </div>
